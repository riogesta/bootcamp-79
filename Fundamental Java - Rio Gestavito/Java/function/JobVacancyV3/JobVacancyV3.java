...
public class JobVacancyV3{
    public static void main(String[] args ){
        ...
        if (posisi.equalsIgnoreCase("koordinator")) {
            ...
            if (validasiKoordinator(nama, umur, jenisKelamin, lulusan, pengalaman, penampilan, posisi)) {
            ...
            if (validasiAdmin(nama, umur, jenisKelamin, lulusan, pengalaman, penampilan, posisi)) {
                result = "selamat, "+ nama +". anda memenuhi syarat untuk sebagai "+posisi+" dan akan masuk ke tahap selanjutnya.";
            } else {
                result = "Maaf, "+ nama +". anda tidak memenuhi syarat untuk sebagai "+posisi+". dan tidak akan masuk ke tahap selanjutnya.";
            }
            ...
            if (validasiSpv(nama, umur, jenisKelamin, lulusan, pengalaman, penampilan, posisi)) {
                result = "selamat, "+ nama +". anda memenuhi syarat untuk sebagai "+posisi+" dan akan masuk ke tahap selanjutnya.";
            } else {
                result = "Maaf, "+ nama +". anda tidak memenuhi syarat untuk sebagai "+posisi+". dan tidak akan masuk ke tahap selanjutnya.";
            }
    ...
    public static boolean validasiKoordinator(String nama, int umur, String jenisKelamin, String lulusan, int pengalaman, int penampilan, String posisi) {
    ...
    public static boolean validasiAdmin(String nama, int umur, String jenisKelamin, String lulusan, int pengalaman, int penampilan, String posisi) {
    ...
    public static boolean validasiSpv(String nama, int umur, String jenisKelamin, String lulusan, int pengalaman, int penampilan, String posisi) {
